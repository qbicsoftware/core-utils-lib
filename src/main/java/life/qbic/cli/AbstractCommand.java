...
public abstract class AbstractCommand {
  ...
  public static <T extends AbstractCommand> T parseArguments(final Class<T> commandClass, final String[] args) {
    ...
    return CommandLine.populateCommand(createDummyCommand(commandClass), args);
  }

  /**
   * Utility method to construct a dummy command.
   * @param commandClass the class of the command.
   * @param <T> the type of the desired command.
   * @return a dummy instance of {@code T}, containing defaults.
   */
  static <T extends AbstractCommand> T createDummyCommand(final Class<T> commandClass) {
